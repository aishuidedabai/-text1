...
+ (void)showLaunchAnimationViewToWindow
{
    ...
    backGroundImageView.image = [UIImage imageNamed:@"shanping"];//背景图
    ...
    [UIView animateWithDuration:0.8f delay:0.0f options:UIViewAnimationOptionBeginFromCurrentState | UIViewAnimationOptionCurveLinear animations:^{
        
        NSInteger randomTranslationValueX = imageViewsborderOffset +0;
        NSInteger randomTranslationValueY = 50;//飞行距离
